...
const containerAttr = ['title', 'class', 'style', 'disabled', 'readonly', 'name', 'value', 'id'];
/**
...
let ChipList = class ChipList extends Component {
     ...
     */
    find(fields) {
        let chipData = { text: '', index: -1, element: this.element, data: '' };
        ...
        if (chipElement && this.chipType()) {
            ...
            let chip = this.chips[chipData.index];
