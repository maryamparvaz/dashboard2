import { Animation, Browser, ChildProperty, Complex, Component, Event, NotifyPropertyChanges, Property, animationMode, compile, createElement, extend, isBlazor, isNullOrUndefined, merge, remove, resetBlazorTemplate, updateBlazorTemplate } from '@syncfusion/ej2-base';
...
let Tooltip = class Tooltip extends Component {
    ...
    renderTooltipElement(areaBounds, location) {
        ...
        if (!isNullOrUndefined(groupElement)) {
            ...
            const borderColor = ((this.theme === 'Fabric' || this.theme === 'Fluent') && !this.border.color) ? '#D2D0CE' : this.border.color;
    ...
    renderContentRTL(textElement$$1, isHeader, markerSize, contentWidth) {
        if (this.enableRTL) {
            let tspanElement;
            let contentWidthIndex = isHeader ? 1 : 0;
            for (let i = 0; i < textElement$$1.childNodes.length; i++) {
...
export { TextStyle, TooltipBorder, AreaBounds, ToolLocation, Tooltip, getTooltipThemeColor, measureText, withInAreaBounds, findDirection, Size, Rect, Side, CustomizeOption, TextOption, getElement, removeElement, drawSymbol, calculateShapes, PathOption, textElement, TooltipLocation, SvgRenderer, CanvasRenderer };
